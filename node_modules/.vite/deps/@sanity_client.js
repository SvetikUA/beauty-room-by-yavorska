...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
	...
	return typeof XMLHttpRequest < "u" ? defer(async () => {
		let { uploadWithProgress } = await import("./browserUpload-CwpNx7Vl-C7CcwBuy.js"), req = _prepareRequest(client, { ...baseRequest });
